"""Tests that CRUD herminig remotes."""
...
from pulp_herminig.tests.functional.constants import DOWNLOAD_POLICIES
...
from pulpcore.client.pulp_herminig import RemotesHerminigApi
...
class CRUDRemotesTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.remote_api = RemotesHerminigApi(gen_herminig_client())
...
class CreateRemoteNoURLTestCase(unittest.TestCase):
    ...
    def test_all(self):
        ...
        * `Pulp Smash #984 <https://github.com/pulp/pulp-smash/issues/984>`_
        ...
        del body["url"]
        with self.assertRaises(ApiException):
            RemotesHerminigApi(gen_herminig_client()).create(body)
